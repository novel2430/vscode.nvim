...
theme.set_highlights = function(opts)
    ...
    hl(0, 'IblIndent', { fg = c.vscContextCurrent, bg = 'NONE', nocombine = true })
    hl(0, 'IblScope', { fg = c.vscLineNumber, bg = 'NONE', nocombine = true })
    ...
    hl(0, 'LspReferenceText', { fg = 'NONE', bg = isDark and '#51576d' or c.vscPopupHighlightLightBlue })
    hl(0, 'LspReferenceRead', { fg = 'NONE', bg = isDark and '#51576d' or c.vscPopupHighlightLightBlue })
    hl(0, 'LspReferenceWrite', { fg = 'NONE', bg = isDark and '#51576d' or c.vscPopupHighlightLightBlue })
